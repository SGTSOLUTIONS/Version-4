...
class VariationController extends Controller
{
    ...
    public function areaVariation($wardId)
    {
        ...
        $ugdTableName = "ugd_tax_{$corp}";
        $professionalTaxTableName = "professional_tax_{$corp}";
        ...
        $misData = DB::table($misTableName . ' as mis')
            ...
            ->leftJoin($ugdTableName . ' as ugd', 'mis.assessment', '=', 'ugd.assessment')
            ->leftJoin($professionalTaxTableName . ' as pt', 'mis.assessment', '=', 'pt.assessment')

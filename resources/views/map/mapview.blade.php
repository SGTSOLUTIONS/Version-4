        ...
        $(document).ready(function() {
            ...
            function buildSearchIndex() {
                ...
                pointDatas.forEach(pd => {
                    try {
                        // Skip if coordinates is undefined or null
                        if (!pd.coordinates) {
                            console.warn('Skipping pointData with missing coordinates:', pd.gisid);
                            return;
                        }
                        let coords;
                        try {
                            coords = typeof pd.coordinates === 'string' ? JSON.parse(pd.coordinates) : pd
                                .coordinates;
                        } catch (parseErr) {

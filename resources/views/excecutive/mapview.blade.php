...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // ════════════════════════════════════════════════════════════
            // 3D VIEW TOGGLE — Cesium globe with Drone Image as Base
            // ════════════════════════════════════════════════════════════
            ...
            async function init3DViewerWithDroneBase() {
                ...
                cesiumViewer.container.insertAdjacentHTML('beforeend',
                    '<div class="cesium-info-box">🧊 3D view with Drone Image as Base — switch back to 2D to edit</div>'
                );
            ...
            console.log('✅ Executive GIS Dashboard ready with Drone Image as Base in 3D view');
        });
    </script>
@endpush

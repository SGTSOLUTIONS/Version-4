...
@section('content')
    ...
    {{-- Building Data Modal (Create/Edit) --}}
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div id="qc_remarks_building_error" class="error-message text-danger small"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content bld-modal-content">
                <div class="modal-header bld-modal-header">
                    <div class="bld-header-inner">
                        ...
                        <div>
                            <h5 class="modal-title bld-modal-title">Building Details</h5>
            ...
            <div class="modal-content bld-modal-content">
                <div class="modal-header bld-modal-header">
                    <div class="bld-header-inner">
                        ...
                        <div>
                            <h5 class="modal-title bld-modal-title">Assessment Records</h5>
            ...
            <div class="modal-content bld-modal-content">
                <div class="modal-header bld-modal-header">
                    <div class="bld-header-inner">
                        ...
                        <h5 class="modal-title bld-modal-title">Quality Check</h5>
                    </div>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-4">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
                    ...
                    <div class="point-data-card">
                        <div class="point-data-card-header">
                            ...
                            <div class="point-data-card-actions">
                                ...
                                <button class="pdc-action-btn pdc-edit-btn" title="Edit" data-id="${pd.id}"><i class="bi bi-pencil"></i></button>
                                <button class="pdc-action-btn" style="background:#fef9c3;color:#92400e;" title="Quality Check" data-id="${pd.id}" data-qc-btn><i class="bi bi-clipboard-check"></i></button>
                            </div>
                        </div>
                    ...
                    (res.data || []).forEach(pd => {
                        html += `
                            <div class="search-result-item">
                                ...
                                <div class="search-result-subtitle">GIS ID: ${pd.point_gisid || 'N/A'}</div>
            ...
            console.log('✅ GIS Dashboard ready — Complete with QC and building view!');
        });
    </script>
@endpush

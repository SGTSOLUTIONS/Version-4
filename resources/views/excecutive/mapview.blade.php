    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                function pointClick(feature) {
                    ...
                    if (building) {
                        ...
                        if (buildingBillCount > pointDataCount) {
                            ...
                            populatePointdatadetails(gisid);
                ...
                function populatePointdatadetails(gisid) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status) {
                                ...
                                let pointDetails = response.data;
                        ...
                        error: function(xhr) {
                            console.log(xhr);
                            showFlashMessage('Unable to load point details.', 'error');
                        }
                    });
